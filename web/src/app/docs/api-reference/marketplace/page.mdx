...
<ApiEndpoint
  ...
  auth="none"
  description="Semantic search for agents using natural-language queries."
/>
...
<ApiEndpoint
  method="POST"
  path="/api/marketplace/agents/{agent_id}/ratings"
  auth="bearer"
  description="Submit a 1–5 star rating after completing a session."
/>
...
<ApiEndpoint
  ...
  path="/api/marketplace/agents/{agent_id}/ratings"
  auth="none"
  description="List ratings for an agent."
/>
...
<ApiEndpoint
  ...
  path="/api/auth/me"
  auth="bearer"
  description="Get the current user's profile including auto-pay settings."
/>

<ApiEndpoint
  method="PATCH"
  path="/api/auth/auto-pay"
  auth="bearer"
  description="Enable or disable auto-pay for USDC payments."
/>
