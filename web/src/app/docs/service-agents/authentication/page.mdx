...
<Callout type="error" title="Never skip validation">
  Without key validation, anyone who discovers your agent's URL can invoke it and run up your LLM costs without payment. Always verify the key on every `/invoke` call.
</Callout>
